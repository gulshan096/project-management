		...
		<div class="content-wrapper">
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-12">
							<h1><a href="#">Home</a> <i class="far fa-chevron-right"></i>Cancel Project</h1>
						</div>
					</div>
				</div>
			</section>
										...
										<?php
										   if(!empty($released_project))
										   {
											...
											<tr>
												...
												<td><b><?php echo !empty($row1['status'] == 2)?'cancel':''; ?></b></td>
										...
										<?php
										   if(!empty($released_work_order))
										   {
											...
											<tr>
    											...
    											<td><?php echo !empty($row2['status'] == 2)?'cancel':''; ?></b></td>
										...
										<tbody>
										   ...
										   if(!empty($released_resource_work_order))
										   {
											...
											<tr>
    												...
    												<td><?php echo !empty($row3['status'] == 2)?'cancel':''; ?></b></td>
