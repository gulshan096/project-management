	...
	class Project extends CI_Controller
		{	
			...
			public function __construct()
			{
				...
				$this->load->model('production/ProProjectModel');	
			}
			...
			public function project()
			{
			  ...
			  $this->load->view("production/project", $data);
			} 

			public function manage_projetct()
			{
				echo $this->ProProjectModel->manage_project();
			}
			...
			public function editProject()
			{
				...
				$data =  $this->ProProjectModel->get_one_project($id);
