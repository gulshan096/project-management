						...
						<div class="col-12">
							<div class="card">
								<div class="card-header">
									<h3 class="card-title mt-0">Add Labour Ticket</h3>
								</div>
								<div class="card-body">
									<form action="" method="post">
										<div class="row">
											<div class="col-md-4 col-12">
												<div class="input-group mb-4">
													<input type="text" class="form-control" placeholder="Enter Labour Name" />
											...
											<div class="col-md-4 col-12">
												<div class="input-group mb-4">
													<select class="custom-select">
														<option value="" disabled selected>Select Labour Designation</option>
										...
										<div class="row">
											<div class="col-md-4 col-12">
												<div class="input-group mb-4">
													<input type="text" class="form-control" placeholder="Please enter the Labour Id" />
											...
											<div class="col-md-4 col-12">
												<div class="input-group mb-4">
													<select class="custom-select">
														<option value="" disabled selected>Select Labour Ticket Type</option>
										...
										<div class="row">
											<div class="col-md-4 col-12">
												<div class="input-group mb-4">
													<input type="text" class="form-control" placeholder="HH:MM" onfocus="(this.type='time')" />
										...
										<div class="row">
											<div class="col-md-4 col-12">
												<div class="input-group mb-5">
													<input type="file" class="form-control file-up" />
													<span class="placeholder">Upload Image</span>
													<label class="file-label">Or drag and drop file here</label>
												</div>
											</div>
										...
										<div class="row">
											<div class="col-12">
												<button type="button" class="btn btn-primary pr-5 pl-5 mr-3" onclick="location.href='labour-card-update.html';">Add</button>
