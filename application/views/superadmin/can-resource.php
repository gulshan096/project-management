		...
		<div class="content-wrapper">
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-12">
							<h1><a href="<?php echo base_url('superadmin/home'); ?>">Home</a> <i class="far fa-chevron-right"></i> <a href="<?php echo base_url('superadmin/cancel'); ?>">Cancel</a> <i class="far fa-chevron-right"></i> Resource</h1>
						</div>
					</div>
				</div>
			</section>
									...
									<table class="table table-hover text-nowrap" id="dataTable">
										...
										?>
											<tr>
												...
												<td><button class="btn btn-danger btn-sm  cancel" data-id="<?php echo $row['id']; ?>" role="button" data-toggle="modal" data-target="#resourceModal">Cancel</button>  </td>  
											</tr>
											 <?php
										    }
										    }
			...
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form onsubmit="return dorequest('<?php echo base_url('superadmin/Cancel/cancel_resources'); ?>','.dologinfrm','.dologinres');" method="POST" class="dologinfrm">
